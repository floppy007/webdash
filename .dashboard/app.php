...
define('HOMELAB_SVG_ICONS', [
    ...
    'haproxy' => ['label'=>'HAProxy', 'svg'=>'<svg xmlns="http://www.w3.org/2000/svg" id="hl75cb_Layer_1" x="0" y="0" version="1.1" viewBox="0 0 512 512"><style>.st0,.st1{fill:none;stroke:#284a6a;stroke-width:.26;stroke-miterlimit:10}.st1{stroke-width:.13}.st4{fill:#3378bc}.st5{fill:#169bd6}.st6{fill:#00a8da}</style><path d="m255.8 189.5-53.2-60.1" class="st0"/><path d="m88 143.3 41.6 60.8" class="st1"/><path d="m255.8 189.6 52.6-60.8m11 127.9 62.5-52.6m-62.5 52.5 62.5 54.9M309 381l-53.2-59m-53.2 59 53.2-59m-126.1-12.8 60.1-52.6M129.7 204l60.1 52.6m66-67.1L129.7 204m126.1-14.5L381.9 204m-62.5 52.6-11-127.8m11 127.8L309 381m72.8-69.4-126 10.4m-126.1-12.8L255.8 322m-53.2 59-12.8-124.3m12.8-127.3-12.8 127.2" class="st0"/><path d="m71.9 220.2 57.8-16.2m12.1-118 60.8 43.4m13.9-70.6-13.9 70.6m13.9-70.6 91.9 70m-13.9-70 13.9 70M369.1 86l-60.8 42.8m115.2 14.5-115.1-14.5m73.4 75.2 41.6-60.8M381.8 204l59 16.2m-59-16.2 57.8 87.9M294.5 58.8l-92 70.6M381.8 204 369 86m12.8 225.6 57.8-19.7m-57.8 19.7 59-91.4m-59 91.4 41.6 56.1m-41.6-56.1L369 424.9M309 381l60.1 44M309 381l114.5-13.3M309 381l-13.8 71m13.8-71-92.5 71m-13.9-71 13.9 71.2M202.6 381l92.6 71m-92.5-71-60.8 44m60.8-44L88 368.2m41.7-59-41.7 59m41.7-59 12.1 115.7m-12.1-115.7-58.4-17.9m58.4-87.3-58.4 87.3m58.4 17.9-57.8-89.1M141.8 86l-12.1 118M88 143.3l114.5-13.9" class="st1"/><path d="M141.8 86 97.3 65.2M141.8 86l-3.5-48.6m78.2 21.4-78.1-21.4m78.1 21.4L183 17.7m33.5 41.1 13.9-49.2M141.8 86l41.1-68.2m111.6 41L230.3 9.6m64.2 49.2L280 7.9m-63.6 50.9L280 7.9m14.5 50.9L328 17.7M369.1 86 328 17.8M369.1 86l4-48.6m-78.6 21.4 78.6-21.4m-4 48.6 45.6-23.1M369.1 86l79.2 12.1m-24.8 45.2 24.9-45.1m-24.9 45.1-8.7-80.4m8.7 80.4 52-4m-52 4 71.2 40.5m-53.9 36.4 34.7-81m-34.7 81 53.8-36.4m-53.8 36.4 60.1 12.1m-61.2 59.6 61.3-59.6m-61.3 59.6 63-11.6m-61.9-60.1 61.9 60.1m-63 11.6 53.8 35.9m-70 39.8 70-39.9m-70 39.9 51.5 5.2m-35.2-80.9 35.2 81m-51.4-5.3 24.3 45.6m-24.3-45.6-9.3 79.8m-.1.1-45.1-22.6m0 0 3.5 50.4m-3.5-50.4 78.6-11.6m-78.6 11.6L328 494.3M295.2 452l32.8 42.2M295.2 452l77.5 23.1M295.2 452 280 504m15.2-52-64.8 52m-13.9-52 13.9 52m-13.9-52 63.5 52m-63.5-52-33 42.2m-41.7-69.3 41.6 69.4m33.1-42.3-78.6 24.3m3.9-51.4-4 51.5m4-51.5-45.1 24.9M88 368.2l8.7 81.5m45.1-24.8-79.2-11M88 368.2l-25.4 45.6M88 368.2l-52 5.2m52-5.2-71.6-39.9m54.9-37-54.9 37m54.9-37-62.5-11m62.5 11-35.2 82.1m35.8-153.2-63 60.1m62.4 11-62.5-59m63.1-12.1-53.8-35.9m53.8 35.9-63 12.1m63-12.1-35.9-81m52 4.1-52-4m52 4-69.9 41.1M88 143.3l-24.8-42.8M88 143.3l9.3-78.1M141.8 86l-78.7 14.5" style="fill:none;stroke-miterlimit:10;stroke:#24405d;stroke-width:.101"/><path d="m158.9 286.7.4-60.8 60.8.4-.4 60.8zm65.8-67 .4-60.8 60.8.4-.4 60.8zm0 133.4.4-60.8 60.8.4-.4 60.8zm66.4-67 .4-60.8 60.8.4-.4 60.8z" style="fill:#256ea5"/><path d="m287.6 150 .3-42.2 42.4.3-.3 42.2zm-106-.1.3-42.2 42.4.3-.3 42.2zm-73.4 75.2.3-42.2 42.4.3-.3 42.2zm0 106.1.4-42.2 42.4.4-.4 42.2zm252.8-.8.3-42.2 42.4.3-.3 42.2zm.8-105 .4-42.2 42.4.4-.4 42.2z" class="st4"/><path d="m73.9 157 .2-27.8 27.7.2-.2 27.8zm54.1-56.5.2-27.8 27.7.2-.2 27.8zm74.6-27.9.2-27.8 27.7.2-.2 27.8zM57.5 233.9l.2-27.8 27.5.2-.2 27.8zm352-104.2 27.8-.2.2 27.7-27.8.2zm-54.2-57.5 27.8-.2.2 27.7-27.8.2zM280.5 45l27.8-.2.2 27.7-27.8.2zm145.1 161.5 27.8-.2.2 27.7-27.8.2z" class="st5"/><path d="m181 403.2.3-42.2 42.4.3-.3 42.2zm106 0 .3-42.2 42.4.3-.3 42.2z" class="st4"/><path d="m409.3 381.8.2-27.8 27.7.2-.2 27.8zm-53.6 57.1.2-27.8 27.7.2-.2 27.8zm-74.5 27.4.2-27.8 27.7.2-.2 27.8zM425.6 305l.2-27.8 27.7.2-.2 27.8zM73.9 354.1l27.8-.2.2 27.7-27.8.2zm54.2 56.8 27.8-.2.2 27.7-27.8.2zm74.2 27.3 27.8-.2.2 27.7-27.8.2zM57.8 277.3l27.8-.2.2 27.7-27.9.2z" class="st5"/><path id="hl75cb_B" d="m467.5 146.7.1-15 15.3.1-.1 15z" class="st6"/><path id="hl75cb_B_00000097501457920659881830000007613161561513566362_" d="m487.3 192.1.1-15 15.3.1-.1 15z" class="st6"/><path id="hl75cb_B_00000071547014281121237290000002545514919948145049_" d="m440.8 106.5.1-15 15.3.1-.1 15z" class="st6"/><path id="hl75cb_B_00000108309099993383869620000014834865271147237535_" d="m89.6 72.1.1-15 15.3.1-.1 15z" class="st6"/><path id="hl75cb_B_00000036253792323724161050000017025648922934108033_" d="m1.6 239.8.1-15 15.3.1-.1 15z" class="st6"/><path id="hl75cb_B_00000003079909837249441410000011739665190993049492_" d="m407 72.1.1-15 15.3.1-.1 15z" class="st6"/><path id="hl75cb_B_00000026124844826931063100000010440354873156949909_" d="m10.4 192.1.1-15 15.3.1-.1 15z" class="st6"/><path id="hl75cb_B_00000170984863259660582880000017542866024396890781_" d="m175.8 25.5.1-15 15.3.1-.1 15z" class="st6"/><path id="hl75cb_B_00000047038855529388422380000016917034070735864999_" d="m29 146.6.1-15 15.3.1-.1 15z" class="st6"/><path id="hl75cb_B_00000152972174886506039780000005477888439546508442_" d="m56.4 105.9.1-15 15.3.1-.1 15z" class="st6"/><path d="m130.6 29.8 15-.1.1 15.3-15 .1zM223.5.3l15-.1.1 15.3-15 .1z" class="st6"/><path id="hl75cb_B_00000057136687109295219670000015391813752341540739_" d="m366.2 45.3.1-15 15.3.1-.1 15z" class="st6"/><path id="hl75cb_B_00000052065239389821694060000018327473300432699039_" d="m494.9 239.2.1-15 15.3.1-.1 15z" class="st6"/><path d="m272.4 15 .1-15 15.3.1-.1 15z" class="st6"/><path id="hl75cb_B_00000103242960986684411540000014521877990177126306_" d="m320.2 24.9.1-15 15.3.1-.1 15z" class="st6"/><path id="hl75cb_B_00000106830210758259549100000012271491575892626322_" d="m407 455.3.1-15 15.3.1-.1 15z" class="st6"/><path id="hl75cb_B_00000016756049568836926160000004593568279343019911_" d="m494.9 287.6.1-15 15.3.1-.1 15z" class="st6"/><path id="hl75cb_B_00000134928594214955112640000001735054422448489644_" d="m89.6 455.3.1-15 15.3.1-.1 15z" class="st6"/><path id="hl75cb_B_00000064341922540891846050000002759780245424861593_" d="m487.3 336 .1-15 15.3.1-.1 15z" class="st6"/><path id="hl75cb_B_00000114756557076627815260000012139680473946634135_" d="m320.2 502.5.1-15 15.3.1-.1 15z" class="st6"/><path id="hl75cb_B_00000088852300520418550050000012981349405070857374_" d="m467.5 381.3.1-15 15.3.1-.1 15z" class="st6"/><path id="hl75cb_B_00000107565796560585250970000000771644178080779668_" d="m440.8 422.1.1-15 15.3.1-.1 15z" class="st6"/><path d="m365.6 468.3 15-.1.1 15.3-15 .1zm-92.3 28.4 15-.1.1 15.3-15 .1z" class="st6"/><path id="hl75cb_B_00000046302001409149730030000001058363891885835174_" d="m130.9 483.8.1-15 15.3.1-.1 15z" class="st6"/><path id="hl75cb_B_00000007391695294084511430000001585176684106240930_" d="m28.4 380.8.1-15 15.3.1-.1 15z" class="st6"/><path id="hl75cb_B_00000106867634139900025310000010728328781746264241_" d="m10.4 335.9.1-15 15.3.1-.1 15z" class="st6"/><path id="hl75cb_B_00000160151161497024061790000009953166547806292877_" d="m55.8 422.1.1-15 15.3.1-.1 15z" class="st6"/><path id="hl75cb_B_00000058562238711190495490000006481508153496747946_" d="m1.6 287.6.1-15 15.3.1-.1 15z" class="st6"/><path id="hl75cb_B_00000022520615080886752770000012018997074303154580_" d="m224.1 511.8.1-15 15.3.1-.1 15z" class="st6"/><path id="hl75cb_B_00000112613330749112891540000009885944769618053561_" d="m175.2 501.9.1-15 15.3.1-.1 15z" class="st6"/></svg>'],
    ...
    'pfsense' => ['label'=>'pfSense', 'svg'=>'<svg xmlns="http://www.w3.org/2000/svg" id="hl3a4b_Layer_1" x="0" y="0" version="1.1" viewBox="0 0 512 512"><style>.st1{fill:#1a1a1a}</style><path d="M465 512H47c-26 0-47-21-47-47V47C0 21 21 0 47 0h418c26 0 47 21 47 47v418c0 26-21 47-47 47" style="fill:#fff"/><path d="M148 361.4c19.2 0 35.7-5.9 49.5-17.2 13.9-11.2 23.8-26.4 29.1-44.9s4-33.7-3.3-44.9-21.1-17.2-40.3-17.2-35.7 5.9-49.5 17.2c-13.9 11.2-23.1 26.4-28.4 44.9s-4.6 33.7 3.3 44.9c6.6 11.9 19.8 17.2 39.6 17.2" class="st1"/><path d="m311.8 237.2 17.2-60.8h30.4l11.9-43.6c4-13.2 8.6-26.4 14.5-38.3 5.3-11.9 13.2-22.5 22.5-31.7 9.2-9.2 21.1-16.5 35-21.8s31.7-8 52.2-8c5.3 0 9.9 0 15.2.7-4.6-19.2-21.8-33-41.6-33.7H42.9C19.2 0 0 19.8 0 43.6v379.2l69.4-246.4h70l-9.2 32.4h1.3c4-4.6 9.2-8.6 15.9-13.2 6.6-4.6 13.2-8.6 20.5-12.6s15.2-6.6 23.8-9.2 17.2-3.3 25.8-3.3c18.5 0 33.7 3.3 46.9 9.2s23.1 15.2 31.1 26.4c6.6 9.9 10.6 21.8 12.6 35.7l5.3-4h-1.3v-.6z" class="st1"/><path d="M506.7 98.4c-3.3-.7-7.3-1.3-11.9-1.3-11.9 0-21.8 2.6-29.7 7.9-7.3 5.3-13.9 15.9-18.5 32.4l-11.2 39h42.9l10.6 33.7-27.7 27.1h-42.9l-52.2 185h-75.3l52.2-185h-29.1l-5.9 4c0 1.3.7 3.3.7 4.6 1.3 15.2-.7 32.4-5.9 50.9-4.6 17.2-11.9 33.7-21.8 49.5s-21.1 29.7-33.7 41.6c-13.2 11.9-27.7 21.8-43.6 29.1s-32.4 10.6-50.2 10.6c-15.9 0-29.7-2.6-42.3-7.3-12.6-4.6-21.1-13.2-26.4-25.1h-1.3L50.2 512h418.2c23.8 0 43.6-19.2 43.6-43.6v-368c-2-.6-4-1.3-5.3-2" class="st1"/></svg>'],
    'pihole' => ['label'=>'Pi-hole', 'svg'=>'<svg xmlns="http://www.w3.org/2000/svg" id="hl8080_Layer_1" x="0" y="0" version="1.1" viewBox="82 0 348 512"><style>.st1{fill:#91180c}.st2{fill:#f42e1c}</style><linearGradient id="hl8080_SVGID_1_" x1="313.659" x2="1028.964" y1="62.878" y2="62.878" gradientTransform="matrix(.3694 0 0 -.3694 -23.212 102.238)" gradientUnits="userSpaceOnUse"><stop offset="0" style="stop-color:#12b212"/><stop offset="1" style="stop-color:#0f0"/></linearGradient><path d="M226.1 157.3C162.1 150.5 97.7 102.2 92.7 0 191.8 0 244.9 58.7 250 151.8c18.8-111.6 106.7-98.5 106.7-98.5 4.2 63.2-47.8 101.6-106.7 104.8-16.5-35-115.7-120.5-115.7-120.5-.1-.1-.3-.1-.4 0q-.15.15 0 .3s95.7 83.4 92.2 119.4" style="fill:url(#hl8080_SVGID_1_)"/><path d="M256 512c-6.2-.4-63.9-2.6-67.4-67.4-2.8-39.4 28.3-68.5 28.3-106.7-7.1-95.4-134.9-83.6-134.9 0-.1 20.9 8.2 40.9 23 55.7l95.2 95.3c14.8 14.8 34.8 23 55.7 23" class="st1"/><path d="M430 337.9c-.4 6.2-2.6 63.9-67.4 67.4-39.4 2.8-68.5-28.3-106.7-28.3-95.4 7.1-83.6 134.8 0 134.8 20.9.1 40.9-8.2 55.7-23l95.3-95.2c14.8-14.8 23-34.8 23-55.7" class="st2"/><path d="M256 163.9c6.2.4 63.9 2.6 67.4 67.4 2.8 39.4-28.3 68.5-28.3 106.7 7.1 95.4 134.8 83.6 134.8 0 .1-20.9-8.2-40.9-23-55.7L311.7 187c-14.8-14.8-34.8-23-55.7-23" class="st1"/><path d="M82.3 337.9c.4-6.2 2.6-63.9 67.4-67.4 39.4-2.8 68.5 28.3 106.7 28.3 95.4-7.2 83.6-134.8 0-134.8-20.9-.1-40.9 8.2-55.7 23l-95.3 95.3c-14.8 14.8-23 34.8-23 55.7" class="st2"/></svg>'],
...
<?php else: ?>
  ...
  <div class="ml-list">
    ...
    <div class="ml-item">
      <?php $mlHasLogo = !empty($dashCfg['project_logo_dark_ext'][$ml['name']]) || !empty($dashCfg['project_logo_light_ext'][$ml['name']]); $mlHlIcon = $dashCfg['project_homelab_icon'][$ml['name']] ?? ''; ?>
      <span class="ml-icon"><?php if ($mlHasLogo): ?><img src="/?asset=project-logo&name=<?= urlencode($ml['name']) ?>&variant=dark" alt="" class="proj-logo-dark" style="width:1.3em;height:1.3em;object-fit:contain;border-radius:3px"><img src="/?asset=project-logo&name=<?= urlencode($ml['name']) ?>&variant=light" alt="" class="proj-logo-light" style="width:1.3em;height:1.3em;object-fit:contain;border-radius:3px"><?php elseif ($mlHlIcon && isset(HOMELAB_SVG_ICONS[$mlHlIcon])): ?><span style="display:inline-flex;width:1.3em;height:1.3em"><?= homelabIconSvg($mlHlIcon) ?></span><?php else: ?><?= !empty($dashCfg['project_icons'][$ml['name']]) ? $dashCfg['project_icons'][$ml['name']] : "\xf0\x9f\x94\x97" ?><?php endif; ?></span>
      <div class="ml-info">
...
<div class="modal-bg" id="descModal">
  <div class="modal" style="text-align:left;max-width:500px">
    ...
    <form method="POST" action="/" id="descForm" enctype="multipart/form-data" target="_self" onsubmit="syncEditor('descEditor','descFormDesc');closeDescModal()">
      ...
      <!-- Homelab Icons -->
      <div id="homelabPickerWrap" style="margin-bottom:1rem">
        <label class="proj-edit-label"><?= $lang === 'de' ? 'Homelab-Logo' : 'Homelab Logo' ?></label>
        <input type="text" id="homelabSearch" class="modal-input modal-input-text" style="margin-bottom:.5rem;font-size:.75rem;padding:.4rem .6rem" placeholder="<?= $lang === 'de' ? 'Logo suchen...' : 'Search logo...' ?>" oninput="filterHomelabIcons(this.value)">
      ...
      <div id="iconPickerWrap" style="margin-bottom:1rem">
        ...
        <div style="display:flex;gap:.5rem;align-items:center">
          <input type="text" name="project_icon" id="descFormIcon" class="modal-input modal-input-text" style="width:3.5rem;text-align:center;font-size:1.3rem;padding:.5rem;flex-shrink:0" maxlength="4" oninput="if(this.value)clearHomelabIcon()">
...
function editProjectDesc(name,current,icon,title,logoDarkExt,logoLightExt,maintenance,homelabIcon){
  _projName=name;
